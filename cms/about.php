        ...
        <div class="container">        
          ...
          <form method="POST" id="formAbout">                    
              ...
              <div class="custom-control custom-radio col-md-3">
                ...
                <label class="custom-control-label" for="customControlValidation2" ><i data-feather="crosshair" color= '#f8942a'></i></label>
              </div>
              <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input anchor" id="customControlValidation3" value="anchor" name="icon" required>
                <label class="custom-control-label" for="customControlValidation3" ><i data-feather='anchor' color= '#f8942a'></i></label>
              </div>
              <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input activity" id="customControlValidation4" value="activity" name="icon" required>
                <label class="custom-control-label" for="customControlValidation4" ><i data-feather='activity' color= '#f8942a'></i></label>
              </div>
              <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input bar-chart" id="customControlValidation5" value="bar-chart" name="icon" required>
                <label class="custom-control-label" for="customControlValidation5" ><i data-feather='bar-chart' color= '#f8942a'></i></label>
              </div>
              <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input bookmark" id="customControlValidation6" value="bookmark" name="icon" required>
                <label class="custom-control-label" for="customControlValidation6" ><i data-feather='bookmark' color= '#f8942a'></i></label>
              </div>
              <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input coffee" id="customControlValidation7" value="coffee" name="icon" required>
                <label class="custom-control-label" for="customControlValidation7" ><i data-feather='coffee' color= '#f8942a'></i></label>
              </div>
              <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input rss" id="customControlValidation8" value="rss" name="icon" required>
                <label class="custom-control-label" for="customControlValidation8" ><i data-feather='rss' color= '#f8942a'></i></label>
              </div>
              <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input box" id="customControlValidation9" value="box" name="icon" required>
                <label class="custom-control-label" for="customControlValidation9" ><i data-feather='box' color= '#f8942a'></i></label>
              </div>
              <div class="custom-control custom-radio">
                <input type="radio" class="custom-control-input inbox" id="customControlValidation10" value="inbox" name="icon" required>
                <label class="custom-control-label" for="customControlValidation10" ><i data-feather='inbox' color= '#f8942a'></i></label>
              </div>
              <div class="custom-control custom-radio mb-3">
                ...
                <label class="custom-control-label" for="customControlValidation11"><i data-feather='message-square' color= '#f8942a'></i></label>
            ...
            <div class="modal-body">
                <form method="POST" id="FormModalWork">
                    ...
                    <div class="custom-control custom-radio col-md-3">
                        ...
                        <label class="custom-control-label" for="ModalcustomControlValidation2" ><i data-feather="crosshair" color= '#f8942a'></i></label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input anchor" id="ModalcustomControlValidation3" value="anchor" name="edit-icon" required>
                        <label class="custom-control-label" for="ModalcustomControlValidation3" ><i data-feather='anchor' color= '#f8942a'></i></label>
                    </div>
                    <div class="custom-control custom-radio">
                        ...
                        <label class="custom-control-label" for="ModalcustomControlValidation4" ><i data-feather='activity' color= '#f8942a'></i></label>
                    </div>
                    <div class="custom-control custom-radio">
                        ...
                        <label class="custom-control-label" for="ModalcustomControlValidation5" ><i data-feather='bar-chart' color= '#f8942a'></i></label>
                    </div>
                    <div class="custom-control custom-radio">
                        ...
                        <label class="custom-control-label" for="ModalcustomControlValidation6" ><i data-feather='bookmark' color= '#f8942a'></i></label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input coffee" id="ModalcustomControlValidation7" value="coffee" name="edit-icon" required>
                        <label class="custom-control-label" for="ModalcustomControlValidation7" ><i data-feather='coffee' color= '#f8942a'></i></label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input rss" id="ModalcustomControlValidation8" value="rss" name="edit-icon" required>
                        <label class="custom-control-label" for="ModalcustomControlValidation8" ><i data-feather='rss' color= '#f8942a'></i></label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input box" id="ModalcustomControlValidation9" value="box" name="edit-icon" required>
                        <label class="custom-control-label" for="ModalcustomControlValidation9" ><i data-feather='box' color= '#f8942a'></i></label>
                    </div>
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input inbox" id="ModalcustomControlValidation10" value="inbox" name="edit-icon" required>
                        <label class="custom-control-label" for="ModalcustomControlValidation10" ><i data-feather='inbox' color= '#f8942a'></i></label>
                    </div>
                    <div class="custom-control custom-radio mb-3">
                        ...
                        <label class="custom-control-label" for="ModalcustomControlValidation11"><i data-feather='message-square' color= '#f8942a'></i></label>
                        <div class="invalid-feedback">Selecione uma opção</div>                                                                 
                    </div>                                                
                </form>
            </div>
